...
class SibigrapiDoubleGuidedExtended(architecture.Architecture):
    def __init__(self):
    ...
    def prediction(self, sample, training=False):
        ...
        scale2 = [int(self.input_size[0]/2), int(self.input_size[1]/2)]
        ...
        pool2 = tf.contrib.layers.max_pool2d(conv2, [2, 2], stride=2)
        ...
        pool1_scale2 = tf.contrib.layers.max_pool2d(conv1_scale2, [2, 2], stride=2)
        ...
        pool2_scale2 = tf.contrib.layers.max_pool2d(conv2_scale2, [2, 2], stride=2)
        ...
        pool3 = tf.contrib.layers.max_pool2d(conv3, [2, 2], stride=2)
