...
import Architectures.Layers.guided_conv_bn as gcb

class DehazenetGuidedConv(architecture.Architecture):
    """
    ...
    def prediction(self, sample, training=False):
        ...
        guided_trans = gcb.guidedfilter_conv_bn(guided_inputs=brelu, guide_inputs=sample,
